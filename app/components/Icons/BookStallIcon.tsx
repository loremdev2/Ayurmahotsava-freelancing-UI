...
interface BookStallProps {
  className?: string; // Allows customization of the icon's size and color via Tailwind classes
}

const BookStall: React.FC<BookStallProps> = ({ className }) => {
  return (
    <svg
      aria-hidden="true"
      className={`e-font-icon-svg e-fas-store-alt ${className || ''}`}
      viewBox="0 0 640 512"
